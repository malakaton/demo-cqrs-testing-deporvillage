 ...
 */
class getDoctrineMongodb_Odm_HydratorCacheWarmerService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/mongodb-odm-bundle/CacheWarmer/HydratorCacheWarmer.php';
